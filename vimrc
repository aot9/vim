...
hi StatusLine ctermbg=235 ctermfg=215
hi StatusLineNC ctermbg=235 ctermfg=255
hi custom_airline_c ctermbg=235
...
set shiftwidth=4
set tabstop=4
set expandtab " tab = space{tabstop}
set nosmd " don't show mode in command bar
